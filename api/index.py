...
@media(max-height:760px){.surprise-gate{display:flex;flex-direction:column;align-items:center;justify-content:flex-start;overflow-y:auto}.surprise-card{flex:0 0 auto;margin:18px auto;overflow:visible}}
@media(max-height:760px){.surprise-card{padding:20px 24px 22px}.bear{font-size:34px;margin-bottom:2px}.envelope{height:118px;margin:0 auto 13px}.envelope-flap{height:78px}.envelope-seal{top:57px;width:32px;height:32px;font-size:18px}.surprise-title{font-size:clamp(32px,6vw,43px);line-height:.95}.surprise-copy{margin:5px auto 12px;font-size:12px;line-height:1.45}.surprise-form{gap:7px}.surprise-form input{padding:10px 12px}.surprise-error{min-height:17px;font-size:12px}.surprise-form .btn{padding:11px 18px}}
